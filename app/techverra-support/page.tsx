...
import { TechVerraContactForm } from "@/components/forms/techverra-contact-form";
...
export default function TechVerraSupportPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative flex items-center justify-center overflow-hidden pt-[var(--header-height)] min-h-[calc(100vh-var(--header-height))]">
        {/* Background Elements */}
          ...
          >
            ...
            >
              <div className="relative">
                <motion.div 
                  className="w-20 h-20 bg-gradient-to-br from-[#17D492] to-[#14c082] rounded-2xl flex items-center justify-center shadow-2xl shadow-[#17D492]/25"
                ...
                {/* Glow Effect */}
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-br from-[#17D492] to-[#14c082] rounded-2xl blur-xl opacity-30"
                  animate={{
                    opacity: [0.3, 0.6, 0.3],
                    scale: [1, 1.1, 1]
                  }}
            ...
            >
              ...
              <div className="flex justify-center items-center gap-6 opacity-60">
                ...
                >
                  <Shield className="w-4 h-4 text-[#17D492]" />
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.1, opacity: 1 }}
                >
                  <Clock className="w-4 h-4 text-[#17D492]" />
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.1, opacity: 1 }}
                >
                  <Users className="w-4 h-4 text-[#17D492]" />
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#17D492]/10 to-[#14c082]/10">
        <div className="container mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
